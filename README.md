...
<div style="border: 2px solid #ffa500; background-color: #fff8e1; padding: 15px; border-radius: 10px; margin-bottom: 20px; font-family: Arial, sans-serif;">
  <p style="font-size: 1.2em; font-weight: bold; color: #e67e00;">⚠️ Important Notice – No Money Required</p>
...
<ul style="font-family: Arial, sans-serif; font-size: 1.05em; line-height: 1.6;">
  <li>
    <p><span style="font-size: 1.2em; font-weight: bold;">Method 1 – Random Chance from Commands:</span></p>
    <p>Use <code>!summon</code>, <code>!buff</code>, or <code>!potion</code> — 
    each has a <strong>3% chance</strong> to earn <strong>5 GCOIN</strong> 💠!</p>
  </li>

  <li>
    <p><span style="font-size: 1.2em; font-weight: bold;">Method 2 – Leaderboard Reward (Starting Season Zero):</span></p>
    <p>The <strong>Top 1 Constellation</strong> with the highest CP by the end of <strong>Season 0</strong> 
    will automatically earn <strong>500 GCOIN</strong> 🏆!</p>
  </li>
  ...
  <li>
    ...
    <p><code>!register 09950248784</code> 
    <img src="gcash-icon.png" alt="GCash" style="height: 1em; vertical-align: middle;"></p>
  </li>
